    ...
    <footer className={s.footer}>
      <div className={s.footer_content}>
        <div className={s.footer_main}>
          ...
          <div className={s.container}>
            <h3 className={s.container_title}>Підтримка</h3>
            <ul>
              <li>
                <a className={s.container_link} href="tel:+380999999999">
                  +380 99 999 99 99
                </a>
              </li>
              <li>
                <a className={s.container_link} href="mailto:info@tutgarno.ua">
                  info@tutgarno.ua
                </a>
              </li>
              <li>
